...

{
    public class MaintainanceStaffRepositry: InterfaceDataBase
    {
        ...
        public MaintainanceStaffRepositry(IConfiguration config)
        {
            ...
            collection = dbContext.getDataBase().GetCollection<MaintainanceStaff>("collection");//use singletone object to get database 
            //and call that database to get collection of Admin
        }
        private readonly IMongoCollection<MaintainanceStaff> collection;
